<template>
	...
	<div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 h-fit top-0 sticky">
		...
		<div class="p-5">
			<router-link to="/subscribe">
				<h5 class="mb-2 text-2xl font-bold tracking-tight text-palet3 dark:text-white">¡Regístrate ahora! <br> Fácil, rápido y sencillo</h5>
			</router-link>
			<p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Solamente con tu Nombre y tu Correo electrónico.</p>
