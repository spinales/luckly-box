<template>
  ...
  <div class="container px-5 py-24 mx-auto">
      ...
      <div class="rounded-lg overflow-hidden">
        <!-- <img alt="content" class="object-cover object-center h-full w-full" src="../assets/3rs.jpg"> -->
        <video controls class="object-cover object-center h-full w-full">
      ...
      <div class="flex flex-col sm:flex-row mt-10">
        ...
        <h2 class="font-medium title-font mt-4 text-gray-900 text-xl mb-2">Reutiliza</h2>
          <p class="leading-relaxed text-mb mb-4">Reciclar es dar una nueva vida a los envases, reduciendo el consumo de recursos y la degradación del planeta. Sin embargo, para poder obtener todos los beneficios del reciclaje, es necesario hacerlo bien. Debemos conocer qué se puede reciclar y qué no para separar correctamente. Aquí te detallamos los beneficios del reciclar y muchos otros datos curiosos. </p>
        </div>
        ...
        <h2 class="font-medium title-font mt-4 text-gray-900 text-xl mb-2">¿Cómo reciclar en casa?</h2>
          <p class="leading-relaxed text-mb mb-4">Prácticamente todos los elementos que nos rodean pueden reciclarse o reutilizarse, así que el reciclaje debe comenzar en nuestro propio hogar. De hecho, reciclar es un reto de todos, y adquirir nuevos hábitos nos ayuda a conseguir mayor calidad de vida y un planeta más sostenible
        </p>
        </div>
      </div>
    </div>
    <div class="flex flex-wrap justify-around -m-4 mt-6">
      ...
      <div class="p-4 lg:w-1/3 sm:w-1/2 w-full">
        ...
        <div class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          ...
          <p>
            ...
            </span>Involucra a toda tu familia y entorno en tu plan de reciclaje
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="p-4 lg:w-1/3 sm:w-1/2 w-full">
        ...
        <div class="flex flex-col sm:items-start sm:text-left text-center items-center -mb-1 space-y-2.5">
          ...
          <p>
            ...
            </span>Reduce la utilización de combustible, agua y materiales en la generación de un nuevo
producto.
          </p>
          <p>
            <span class="bg-green-100 text-palet3 w-6 h-6 mr-2 rounded-full inline-flex items-center justify-center">
            ...
            </span>Es un aporte para la economía doméstica, ya que disminuye los gastos para comprar nuevos
productos
          </p>
        </div>
      </div>
