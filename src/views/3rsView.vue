    ...
    <div class="container flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
            <div class="w-full mx-auto">
                <h1 class="font-bold text-2xl py-8 capitalize">reduce, reutiliza y recicla.</h1>
                <div class="py-2">
                    <h2 class="font-bold text-lg py-4 capitalize">reutiliza</h2>
                    <p class="text-md">
                        Reciclar es dar una nueva vida a los envases, reduciendo el consumo de recursos y la
                        degradación del planeta. Sin embargo, para poder obtener todos los beneficios del reciclaje, es
                        necesario hacerlo bien.
                        Debemos conocer qué se puede reciclar y qué no para separar correctamente. Aquí te
                        detallamos los beneficios del reciclar y muchos otros datos curiosos.
                    </p>
                </div>
                <div class="py-2">
                    <h2 class="font-bold text-lg py-4 capitalize">Beneficios del reciclaje:</h2>
                    <div class="grid space-y-3 sm:gap-2 sm:grid-cols-2 sm:space-y-0">
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                <span class="mr-4">
                                    <svg
                                        class="w-10 h-10 mt-px text-green-500 bg-green-100 rounded-full p-2"
...
sostenible
                    ...
                    <div class="grid space-y-3 sm:gap-2 sm:grid-cols-2 sm:space-y-0">
                        <ul class="space-y-3">
                            ...
                            <li class="flex items-center">
                                ...
                                envases plásticos como botellas, potes de champú, bolsas de snacks, tapas, etc.
                            </li>
                            <li class="flex items-center">
                                <span class="mr-4">
                                    <svg
                ...
                <div class="py-2">
                    <h2 class="font-bold text-lg py-4 capitalize">Para poder reciclar en casa:</h2>
                    <div class="grid space-y-3 sm:gap-2 sm:grid-cols-2 sm:space-y-0">
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                <span class="mr-4">
                                ...
                                Separa los residuos en recipientes independientes (plásticos, papel, vidrio y aluminio).
                            </li>
                            <li class="flex items-center">
                                <span class="mr-4">
                                    <svg
