...
<template>
    ...
    <h1 class="m-4 sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Preguntas Frecuentes</h1>
    ...
    <div id="accordion-open" data-accordion="open">
        ...
        <div id="accordion-open-body-1" class aria-labelledby="accordion-open-heading-1">
            ...
            >
                ...
                >Flowbite is an open-source library of interactive components built on top of Tailwind CSS including buttons, dropdowns, modals, navbars, and more.</p>
                ...
                <span class="flex items-center">
                    ...
                    >
                        <path
                            ...
                            clip-rule="evenodd"
                        />
                    </svg>Que gana Luckly Box con esto??
                </span>
                <svg
                    data-accordion-icon
                ...
                <span class="flex items-center">
                    ...
                    >
                        <path
                            ...
                            clip-rule="evenodd"
                        />
                    </svg> Quienes son los pricipales fundadores del proyecto??
                </span>
                <svg
                    data-accordion-icon
                    class="w-6 h-6 shrink-0"
        ...
        <div id="accordion-open-body-3" class="hidden" aria-labelledby="accordion-open-heading-3">
            <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                <p
                    class="mb-2 text-gray-500 dark:text-gray-400"
                >The main difference is that the core components from Flowbite are open source under the MIT license, whereas Tailwind UI is a paid product. Another difference is that Flowbite relies on smaller and standalone components, whereas Tailwind UI offers sections of pages.</p>
                <p
                    class="mb-2 text-gray-500 dark:text-gray-400"
                >However, we actually recommend using both Flowbite, Flowbite Pro, and even Tailwind UI as there is no technical reason stopping you from using the best of two worlds.</p>
                <p
                    class="mb-2 text-gray-500 dark:text-gray-400"
