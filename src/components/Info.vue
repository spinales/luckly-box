  ...
  >
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      ...
      <p class="text-base text-gray-700 md:text-lg space-y-4">
        ...
        sus envases para promover la reducción en la generación de residuos.
      </p>
      <p class="text-base text-gray-700 md:text-lg mt-4">
        Desde Lucky Box facilitamos esta cadena que une a ciudadanos y empresas nacionales para
        que, entre todos, hagamos posible el reciclaje de residuos sólidos, contribuyendo así a la
        economía circular.
      </p>
      <p class="text-base text-gray-700 md:text-lg mt-4">
        Para poder desarrollar nuestra labor contamos con un modelo de gestión basado en la
        colaboración de empresas privadas, que se baba en la eficiencia, transparencia e innovación
        tecnológica con tal de alcanzar los objetivos más ambiciosos en materia de reciclaje.
        ¡Garantizamos y prometemos ser agentes de cambio en nuestro país!
      </p>
    </div>
